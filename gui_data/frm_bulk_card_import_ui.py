...
class Ui_frm_bulk_card_import(object):
    def setupUi(self, frm_bulk_card_import):
        ...
        self.btn_search_path_bulkcard_upload = QPushButton(frm_bulk_card_import)
        self.btn_search_path_bulkcard_upload.setObjectName(u"btn_search_path_bulkcard_upload")
        self.btn_search_path_bulkcard_upload.setGeometry(QRect(390, 340, 85, 27))
        font = QFont()
        font.setPointSize(11)
        font.setBold(True)
        self.btn_search_path_bulkcard_upload.setFont(font)
        self.btn_upload_bulkcard = QPushButton(frm_bulk_card_import)
        self.btn_upload_bulkcard.setObjectName(u"btn_upload_bulkcard")
        self.btn_upload_bulkcard.setGeometry(QRect(660, 340, 85, 27))
        ...
        self.le_path_bulkcard = QLineEdit(frm_bulk_card_import)
        self.le_path_bulkcard.setObjectName(u"le_path_bulkcard")
        self.le_path_bulkcard.setGeometry(QRect(70, 340, 300, 30))
    ...
    def retranslateUi(self, frm_bulk_card_import):
        ...
        self.btn_search_path_bulkcard_upload.setText(QCoreApplication.translate("frm_bulk_card_import", u"Search", None))
        self.btn_upload_bulkcard.setText(QCoreApplication.translate("frm_bulk_card_import", u"Upload", None))
