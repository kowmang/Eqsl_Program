...
* **all_files**         changed language to english (print messages)
                        doing various minor bugfixes
* **timetracker**       added work time tracker 
* **support_data**      added folder manual_images and images
...
* **qsl_img_importer**  added take qsl cards from folder and check with adif db 
